...
function( G , filename, layout, filetype )
	...
	if ForAny(GeneratorsOfGroup(G), i -> Order(i) <> 2) then 
		Info(InfoCoreFreeSub,1,"The Faithful Transitive Permutation Representation Graphs were designed for groups generated by involutions. The final graph will not look correct.");
	fi;
